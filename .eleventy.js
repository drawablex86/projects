...
//Short code to easily add youtube embeds to md file. Ex {% youtube "qGs8-xBForM" %}
  // Add YouTube shortcode before other shortcodes
  eleventyConfig.addShortcode("youtube", function(videoId) {
    return `<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; width: 100%; margin-bottom: 1rem;">
      <iframe 
